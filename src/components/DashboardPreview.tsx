          ...
          {activeTab === "dashboard" && (
            ...
            >
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div className="bg-slate-950/80 p-3.5 sm:p-4 rounded-2xl border border-slate-800 relative overflow-hidden group hover:border-blue-500/50 transition-all">
                  <div className="flex items-start justify-between gap-2">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-400 uppercase tracking-wider leading-tight">{t("dash_stat_patients")}</span>
                  ...
                  <p className="text-[11px] text-emerald-400 mt-1 flex items-center gap-1 font-semibold">
                    <TrendingUp className="w-3 h-3" /> 0 ce mois-ci
                  </p>
                </div>

                <div className="bg-slate-950/80 p-3.5 sm:p-4 rounded-2xl border border-slate-800 relative overflow-hidden group hover:border-cyan-500/50 transition-all">
                  <div className="flex items-start justify-between gap-2">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-400 uppercase tracking-wider leading-tight">{t("dash_stat_today_app")}</span>
                  ...
                  <p className="text-[11px] text-cyan-300 mt-1 flex items-center gap-1 font-semibold">
                    <Clock className="w-3 h-3 text-cyan-400" /> Aucun RDV prévu
                  </p>
                </div>

                <div className="bg-slate-950/80 p-3.5 sm:p-4 rounded-2xl border border-slate-800 relative overflow-hidden group hover:border-indigo-500/50 transition-all">
                  <div className="flex items-start justify-between gap-2">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-400 uppercase tracking-wider leading-tight">{t("dash_stat_treatments")}</span>
                  ...
                  <p className="text-[11px] text-indigo-300 mt-1 flex items-center gap-1 font-semibold">
                    <CheckCircle2 className="w-3 h-3 text-indigo-400" /> 0 réalisé aujourd'hui
                  </p>
                </div>

                <div className="bg-slate-950/80 p-3.5 sm:p-4 rounded-2xl border border-slate-800 relative overflow-hidden group hover:border-emerald-500/50 transition-all">
                  <div className="flex items-start justify-between gap-2">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-400 uppercase tracking-wider leading-tight">{t("dash_stat_revenue")}</span>
                  ...
                  <p className="text-[11px] text-emerald-400 mt-1 flex items-center gap-1 font-semibold">
                    <TrendingUp className="w-3 h-3" /> 0% vs semaine dernière
                  </p>
                </div>
              </div>
